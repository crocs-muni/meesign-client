...
final $typed_data.Uint8List protocolTypeDescriptor = $convert.base64Decode(
    'CgxQcm90b2NvbFR5cGUSCAoER0cxOBAAEgsKB0VMR0FNQUwQARIJCgVGUk9TVBACEgoKBk1VU0lHMhAD');
...
const RegistrationRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'csr', '3': 3, '4': 1, '5': 12, '10': 'csr'},
  ],
};
...
final $typed_data.Uint8List registrationRequestDescriptor = $convert.base64Decode(
    'ChNSZWdpc3RyYXRpb25SZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSJwoEa2luZBgCIAEoDjITLm1lZXNpZ24uRGV2aWNlS2luZFIEa2luZBIQCgNjc3IYAyABKAxSA2Nzcg==');
...
final $typed_data.Uint8List registrationResponseDescriptor = $convert.base64Decode(
    'ChRSZWdpc3RyYXRpb25SZXNwb25zZRIbCglkZXZpY2VfaWQYASABKAxSCGRldmljZUlkEiAKC2NlcnRpZmljYXRlGAIgASgMUgtjZXJ0aWZpY2F0ZRIiCgphdXRoX3Rva2VuGAMgASgJSABSCWF1dGhUb2tlbogBAUINCgtfYXV0aF90b2tlbg==');
...
final $typed_data.Uint8List groupRequestDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List groupDescriptor = $convert.base64Decode(
    '');
...
const Device$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_active', '3': 5, '4': 1, '5': 4, '10': 'lastActive'},
  ],
};

/// Descriptor for `Device`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceDescriptor = $convert.base64Decode(
    'CgZEZXZpY2USHgoKaWRlbnRpZmllchgBIAEoDFIKaWRlbnRpZmllchISCgRuYW1lGAIgASgJUgRuYW1lEicKBGtpbmQYAyABKA4yEy5tZWVzaWduLkRldmljZUtpbmRSBGtpbmQSIAoLY2VydGlmaWNhdGUYBCABKAxSC2NlcnRpZmljYXRlEh8KC2xhc3RfYWN0aXZlGAUgASgEUgpsYXN0QWN0aXZl');
...
const DecryptRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'group_id', '3': 2, '4': 1, '5': 12, '10': 'groupId'},
    const {'1': 'data', '3': 3, '4': 1, '5': 12, '10': 'data'},
    const {'1': 'data_type', '3': 4, '4': 1, '5': 9, '10': 'dataType'},
  ],
};
...
final $typed_data.Uint8List decryptRequestDescriptor = $convert.base64Decode(
    'Cg5EZWNyeXB0UmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEhkKCGdyb3VwX2lkGAIgASgMUgdncm91cElkEhIKBGRhdGEYAyABKAxSBGRhdGESGwoJZGF0YV90eXBlGAQgASgJUghkYXRhVHlwZQ==');
...
final $typed_data.Uint8List taskDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List taskUpdateDescriptor = $convert.base64Decode(
    'CgpUYXNrVXBkYXRlEhIKBHRhc2sYASABKAxSBHRhc2sSEgoEZGF0YRgCIAMoDFIEZGF0YRIYCgdhdHRlbXB0GAMgASgNUgdhdHRlbXB0');
