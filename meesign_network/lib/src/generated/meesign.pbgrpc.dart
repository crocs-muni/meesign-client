...
class MeeSignClient extends $grpc.Client {
  ...
  MeeSignClient(super.channel, {super.options, super.interceptors});
  ...
  $grpc.ResponseFuture<$0.Task> signStream(
    $async.Stream<$0.SignRequestChunk> request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(_$signStream, request, options: options).single;
  }
  ...
  $grpc.ResponseFuture<$0.Task> decryptStream(
    $async.Stream<$0.DecryptRequestChunk> request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(_$decryptStream, request, options: options)
        .single;
  }
  ...
  static final _$register =
      $grpc.ClientMethod<$0.RegistrationRequest, $0.RegistrationResponse>(
          ...
          $0.RegistrationResponse.fromBuffer);
  static final _$sign = $grpc.ClientMethod<$0.SignRequest, $0.Task>(
      '/meesign.MeeSign/Sign',
      ($0.SignRequest value) => value.writeToBuffer(),
      $0.Task.fromBuffer);
  static final _$signStream = $grpc.ClientMethod<$0.SignRequestChunk, $0.Task>(
      '/meesign.MeeSign/SignStream',
      ($0.SignRequestChunk value) => value.writeToBuffer(),
      $0.Task.fromBuffer);
  ...
  static final _$decrypt = $grpc.ClientMethod<$0.DecryptRequest, $0.Task>(
      ...
      $0.Task.fromBuffer);
  static final _$decryptStream =
      $grpc.ClientMethod<$0.DecryptRequestChunk, $0.Task>(
          '/meesign.MeeSign/DecryptStream',
          ($0.DecryptRequestChunk value) => value.writeToBuffer(),
          $0.Task.fromBuffer);
...
abstract class MeeSignServiceBase extends $grpc.Service {
  ...
  MeeSignServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SignRequestChunk, $0.Task>(
        'SignStream',
        signStream,
        true,
        false,
        ($core.List<$core.int> value) => $0.SignRequestChunk.fromBuffer(value),
        ($0.Task value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.DecryptRequest, $0.Task>(
        ...
        ($0.Task value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.DecryptRequestChunk, $0.Task>(
        'DecryptStream',
        decryptStream,
        true,
        false,
        ($core.List<$core.int> value) =>
            $0.DecryptRequestChunk.fromBuffer(value),
        ($0.Task value) => value.writeToBuffer()));
  ...
  $async.Future<$0.Task> signStream(
      $grpc.ServiceCall call, $async.Stream<$0.SignRequestChunk> request);
  ...
  $async.Future<$0.Task> decryptStream(
      $grpc.ServiceCall call, $async.Stream<$0.DecryptRequestChunk> request);
