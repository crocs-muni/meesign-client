...
import 'package:meesign_network/src/generated/meesign.pb.dart' as $0;
...
class MeeSignClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.Task> sign(
  ...
  $grpc.ResponseFuture<$0.Task> group(
    $0.GroupRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$group, request, options: options);
  }

  $grpc.ResponseFuture<$0.Task> decrypt(
  ...
  $grpc.ResponseFuture<$0.Resp> updateTask(
    $0.TaskUpdate request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$updateTask, request, options: options);
  }

  $grpc.ResponseFuture<$0.Resp> decideTask(
    $0.TaskDecision request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$decideTask, request, options: options);
  }

  $grpc.ResponseFuture<$0.Resp> acknowledgeTask(
    $0.TaskAcknowledgement request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$acknowledgeTask, request, options: options);
  }

  $grpc.ResponseFuture<$0.Tasks> getTasks(
    $0.TasksRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getTasks, request, options: options);
  }

  $grpc.ResponseFuture<$0.Groups> getGroups(
  ...
  $grpc.ResponseFuture<$0.Devices> getDevices(
    $0.DevicesRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getDevices, request, options: options);
  }

  $grpc.ResponseFuture<$0.Resp> log(
  ...
  $grpc.ResponseStream<$0.Task> subscribeUpdates(
...
abstract class MeeSignServiceBase extends $grpc.Service {
  MeeSignServiceBase() {
    $addMethod(
      $grpc.ServiceMethod<$0.ServerInfoRequest, $0.ServerInfo>(
        'GetServerInfo',
        getServerInfo_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.SignRequest, $0.Task>(
        'Sign',
        sign_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.GroupRequest, $0.Task>(
        'Group',
        group_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.DecryptRequest, $0.Task>(
        'Decrypt',
        decrypt_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.TaskRequest, $0.Task>(
        'GetTask',
        getTask_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.TaskUpdate, $0.Resp>(
        'UpdateTask',
        updateTask_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.TaskDecision, $0.Resp>(
        'DecideTask',
        decideTask_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.TaskAcknowledgement, $0.Resp>(
        'AcknowledgeTask',
        acknowledgeTask_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.TasksRequest, $0.Tasks>(
        'GetTasks',
        getTasks_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.GroupsRequest, $0.Groups>(
        'GetGroups',
        getGroups_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.DevicesRequest, $0.Devices>(
        'GetDevices',
        getDevices_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.LogRequest, $0.Resp>(
        'Log',
        log_Pre,
        false,
        false,
    ...
    $addMethod(
      $grpc.ServiceMethod<$0.SubscribeRequest, $0.Task>(
        'SubscribeUpdates',
  ...
  $async.Future<$0.ServerInfo> getServerInfo_Pre(
    ...
    $async.Future<$0.ServerInfoRequest> request,
  ) async {
    return getServerInfo(call, await request);
  }

  $async.Future<$0.RegistrationResponse> register_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.RegistrationRequest> request,
  ) async {
  ...
  $async.Future<$0.Task> sign_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.SignRequest> request,
  ) async {
  ...
  $async.Future<$0.Task> group_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.GroupRequest> request,
  ) async {
  ...
  $async.Future<$0.Task> decrypt_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.DecryptRequest> request,
  ) async {
  ...
  $async.Future<$0.Task> getTask_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.TaskRequest> request,
  ) async {
  ...
  $async.Future<$0.Resp> updateTask_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.TaskUpdate> request,
  ) async {
  ...
  $async.Future<$0.Resp> decideTask_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.TaskDecision> request,
  ) async {
    return decideTask(call, await request);
  }

  $async.Future<$0.Resp> acknowledgeTask_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.TaskAcknowledgement> request,
  ) async {
  ...
  $async.Future<$0.Tasks> getTasks_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.TasksRequest> request,
  ) async {
  ...
  $async.Future<$0.Groups> getGroups_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.GroupsRequest> request,
  ) async {
  ...
  $async.Future<$0.Devices> getDevices_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.DevicesRequest> request,
  ) async {
  ...
  $async.Future<$0.Resp> log_Pre(
    $grpc.ServiceCall call,
    $async.Future<$0.LogRequest> request,
  ) async {
    return log(call, await request);
  }

  $async.Stream<$0.Task> subscribeUpdates_Pre(
    $grpc.ServiceCall call,
